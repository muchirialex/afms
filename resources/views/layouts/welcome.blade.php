...
<body width="100%" style="margin: 0; font-family: 'Raleway', sans-serif; padding: 0 !important; mso-line-height-rule: exactly; background-color: #222222;">
    ...
    <![endif]-->
        ...
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: 'Raleway', sans-serif;;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto;" class="email-container">
            ...
            <tr>
                <td style="background-color: #ffffff;">
                    <img src="images/email-banner.png" width="600" height="" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: 295px; background: #dddddd; font-family: 'Raleway', sans-serif; font-size: 15px; line-height: 15px; color: #555555; margin: auto;" class="g-img">
                </td>
            </tr>
                            ...
                            <td style="padding: 20px; font-family: 'Raleway', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <p style="margin: 0 0 10px;">Hi {{ $user['name'] }}, <br><br>
                                    ...
                                    <ul style="padding: 0; margin: 0; list-style-type: disc;">
                                        <li style="margin:0 0 10px 20px;" class="list-item-first"><strong>Email:</strong>&nbsp; {{ $user['email'] }}</li>
                                        <li style="margin:0 0 10px 20px;"><strong>Password:</strong>&nbsp; BT#y3W_@</li>
                                    </ul>
                                    <br>
