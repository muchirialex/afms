        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" href="{{ url('admin') }}">All Users</a>
            </div>
            ...
            <div class="col-md-12">
              <div class="col-md-12">
                <div class="card card-plain">
                    ...
                    <h4 class="card-title mt-0"> AFMS Users</h4>
                    <p class="card-category"> List of all our users</p>
                    <div class="add-div-btn">
                      <a href="{{ URL::to('exportUsers/csv') }}" class="add-user-btn">
                        <button class="btn btn-info btn-inline" onclick="demo.showNotification('bottom','right')">Export Users</button>
                      </a>
                      <a href="{{ url('/register') }}" class="add-user-btn">
                        <button class="btn btn-info btn-inline btn-inline-2">Add User</button>
                      </a>
                    </div>
                    </div>
                    <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td class="actions-btn">
                                <a href="/profiles/{{$user->id}}/edit" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons" style="margin-top:-14px;">&#xE8B8;</i></a>
                                
                                <form method="POST" action="/user/{{ $user->id }}/delete" onsubmit = "return ConfirmDelete()">
                        ...
                        <div class="clearfix">
                            <div class="hint-text">Showing <b>{{ $users->firstItem() }} - {{ $users->lastItem() }}</b> out of <b>{{ $users->total() }}</b> entries</div>
                            {{$users->links()}}
                        </div>
                    </div>
                    </div>
