          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
					<form action="/vehicles/create-step1" method="POST">
						{{ csrf_field() }}
					<div class="card-body">
						<div class="tab-content">
							<div class="row justify-content-center">
								<div class="col-sm-4">
									<div class="picture-container mt-5">
										...
										<div class="btn-white">
											<label for="exampleInput1" class="bmd-label-floating">Client name</label>
											<input class="form-control" type="text" name="client_name" autocomplete="off">
										</div>
									</div>
									...
									<div class="picture-container mt-5">
										...
										<div class="btn-white">
											<label for="exampleInput1" class="bmd-label-floating">Contact person</label>
											<input class="form-control" type="text" name="contact_person" autocomplete="off">
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6">	
								...
								<div class="input-group form-control-lg">
									...
									<div class="form-group select-category">
										<label for="exampleInput1" class="bmd-label-floating">Postal address</label>
