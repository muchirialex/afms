        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
          <div class="container-fluid">
            <div class="navbar-wrapper">
              ...
              @else
                <a class="navbar-brand" href="{{ url('users/show') }}">User Profile</a>
              @endif
            </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Fleet completed: <strong style="font-size:1.25em;">#</strong></h4>
                  <p class="card-category">Make sure your profile is up-to-date</p>
                  <div class="add-div-btn">
                    <a href="edit/{{Auth::user()->id}}" class="add-user-btn">
